...
onMounted(() => {
    ...
    ScrollTrigger.create({
        ...
        start: '40% bottom',
        onEnter: () => {
            if (homeExperienceSwiperEle.value && !homeExperienceSwiperEle.value.classList.contains("active")) {
...
<template>
    <section class="sm:py-25 py-15" id="home-experience">
        <div class="container">
            <SplitTextTitle :trigger="'#home-experience'" :ele="'h4'" :title="'Work Experience'" class="text-center" />
            <SplitTextTitle :trigger="'#home-experience'" :ele="'h2'" :title="'工作經驗'" class="text-center mb-10" />
            ...
            <div class="pt-37.5 px-10 relative">
                ...
                <div class="home-experience-swiper" ref="home-experience-swiper">
                    <swiper :modules="homeTimelineModules" :slides-per-view="1" :speed="1000" :centered-slides="true"
                        :navigation="{ prevEl: '.home-timeline-prev', nextEl: '.home-timeline-next' }"
                        :allow-touch-move="false" :initial-slide="3" :breakpoints="{
                            1024: {
                                slidesPerView: 3,
                            },
                            768: {
                        ...
                        <swiper-slide v-for="item in props.homeTimeline" :key="item.id" class="">
                            <HomeTimelineCard :time="item.time" :company="item.company" :title="item.title"
                                :img="item.img" />
                        </swiper-slide>
                    </swiper>
                </div>

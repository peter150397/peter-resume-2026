...
<template>
    <section class="flex flex-col items-start sm:gap-[50vh] gap-[25vh] sm:my-[50vh] my-[25vh]">
        <div v-for="(item, index) in props.imgs" :key="index" class="h-[80vh] sm:w-4/5 w-full overflow-hidden relative"
            :class="index % 2 === 1 ? 'self-end' : ''">
            <img :src="item" alt="" class="h-5/4 w-full object-cover absolute bottom-0" ref="portfolio-parallax">
        </div>
    </section>
</template>

...
onMounted(() => {
    ...
    gsapBreakPoints.add({
        ...
        gsap.fromTo(homeSkillArrayEle.value, {
...
<template>
    <section ref="home-skill" class="h-screen flex flex-col justify-evenly overflow-hidden relative">
        <div class="absolute inset-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="80%" height="100%" viewBox="0 0 381.24 81.121" fill="none" class="mx-auto">
                <path
        ...
        <div v-for="(skillArray, index) in props.homeSkill" :key="'skillArray-' + index" class="flex" ref="home-skill-array">
            <HomeSkillCard v-for="skill in skillArray" :key="skill.id" :img="skill.img" :title="skill.title" />
        </div>
    </section>
</template>
